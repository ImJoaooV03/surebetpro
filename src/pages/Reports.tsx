  ...
  const fetchStats = async () => {
    try {
      ...
      if (data) {
        ...
        // Gerar dados do gráfico para os últimos 7 dias reais
        ...
        const newChartData = last7Days.map(date => {
          ...
          return { 
            ...
            lucro: Number(dayProfit.toFixed(2)) 
          };
        });
  ...
  return (
    <div className="p-6 md:p-10 w-full max-w-7xl mx-auto pb-24">
      ...
      <p className="text-[#8b8d93] text-sm font-medium mb-10 ml-16">
        Análise detalhada das suas estratégias e lucros reais.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
        <div className="bg-[#161618] border border-[#2c2e33] rounded-2xl p-6 shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <div className="w-10 h-10 rounded-lg bg-[#39FF14]/10 flex items-center justify-center"><Target className="w-5 h-5 text-[#39FF14]" /></div>
          </div>
          <div className="text-gray-500 text-sm font-bold mb-1 uppercase">Operações Ganhas</div>
          <div className="text-3xl font-black text-white">{stats.totalWon}</div>
        </div>
        <div className="bg-[#161618] border border-[#2c2e33] rounded-2xl p-6 shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <div className="w-10 h-10 rounded-lg bg-red-500/10 flex items-center justify-center"><Activity className="w-5 h-5 text-red-500" /></div>
          </div>
          <div className="text-gray-500 text-sm font-bold mb-1 uppercase">Operações Falhas</div>
        ...
        <div className="bg-[#161618] border border-[#2c2e33] rounded-2xl p-6 shadow-lg">
          ...
          <div className="text-gray-500 text-sm font-bold mb-1 uppercase">ROI Médio (Ganhas)</div>
        ...
        <div className="bg-[#161618] border border-[#39FF14]/30 rounded-2xl p-6 shadow-[0_0_20px_rgba(57,255,20,0.05)] relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-4 relative z-10">
            <div className="w-10 h-10 rounded-lg bg-[#39FF14] flex items-center justify-center"><DollarSign className="w-5 h-5 text-black" /></div>
          </div>
          <div className="text-[#39FF14] text-sm font-bold mb-1 uppercase relative z-10">Lucro Total</div>
      ...
      {/* Chart */}
      <div className="bg-[#161618] border border-[#2c2e33] rounded-2xl p-6 shadow-lg">
        <h2 className="text-lg font-bold text-white mb-6">Evolução do Lucro (Últimos 7 dias)</h2>
        <div className="h-[300px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData}>
              ...
              />
              <Line type="monotone" dataKey="lucro" stroke="#39FF14" strokeWidth={4} dot={{ r: 6, fill: '#111', stroke: '#39FF14', strokeWidth: 2 }} activeDot={{ r: 8 }} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </div>
