    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white p-6 md:p-10">
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
          <div>
            <h1 className="text-3xl font-extrabold text-white tracking-tight mb-1">Live Scanner</h1>
          ...
          <div className="bg-[#161618] border border-[#2c2e33] rounded-2xl p-16 text-center shadow-lg">
            <div className="flex flex-col items-center justify-center text-[#8b8d93]">
              <div className="w-16 h-16 bg-[#252529] rounded-full flex items-center justify-center mb-4 border border-[#333]">
                <AlertCircle className="w-8 h-8 text-[#555]" />
              </div>
              <p className="text-xl font-bold text-white mb-2">Nenhuma Surebet encontrada no momento</p>
              <p className="text-sm max-w-md text-center leading-relaxed">O motor de arbitragem está varrendo as casas de apostas. Novas oportunidades aparecerão aqui automaticamente.</p>
            </div>
          </div>
        ) : (
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
